...
df1 = process_multiple_files_with_options_euclidean(df_synthetic, base_dir,results_dir,path = "truce_synthetic_euclidean.pkl", top_n=3)
df2 = process_multiple_files_with_options_euclidean(df_stock, base_dir,results_dir,path = "truce_stock_euclidean.pkl", top_n=3)
